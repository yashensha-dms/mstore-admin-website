...
const SetupTab = ({ values, setFieldValue, errors, updateId }) => {
  ...
  // Getting Products Data — disabled: related_products and cross_sell_products fields are hidden
  ...
  // if (productLoader) return <Loader />; // no longer needed — product search query is disabled
  return (
    <>
      ...
      */}
      {/* CrossSellProduct — disabled for now
      <SearchableSelectInput
        nameList={
          [
            {
